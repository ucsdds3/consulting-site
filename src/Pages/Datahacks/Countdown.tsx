...
const Countdown = () => {
  ...
  return (
    <div className="flex flex-col justify-start items-center w-full py-0 md:py-24 font-albert-sans relative">
      {/* Decorative elements - plus signs - hidden on mobile */}
      <div className="hidden md:block absolute left-24 top-1/2 text-gray-700 text-8xl opacity-20">
        +
      </div>
      <div className="hidden md:block absolute right-24 bottom-1/4 text-gray-700 text-8xl opacity-20">
        +
      </div>

      <div className="w-full max-w-3xl mx-auto px-4 flex flex-col mt-4 md:mt-0">
        {/* Content container with the same width as the timer */}
        <div className="w-full">
          {/* Intro text - aligned left */}
          <p
            className={`text-xl md:text-2xl mb-2 md:mb-4 font-albert-sans ${
          ...
          <h1
            className={`text-4xl md:text-5xl lg:text-7xl font-medium mb-2 md:mb-4 font-albert-sans ${
              isDark ? "text-white" : "text-black"
            }`}
            style={{
          ...
          <p
            className={`text-base md:text-xl mb-6 md:mb-12 font-albert-sans ${
              isDark ? "text-white" : "text-black"
            }`}
          >
            Analyze real-world data, build powerful insights, and create
            impactful solutions
          </p>

          {/* Countdown timer */}
          <div
            className={`border rounded-lg py-3 px-2 md:px-4 mb-8 md:mb-12 w-full ${
            ...
            <div className="flex flex-wrap justify-around items-center text-center">
              ...
              <div className="flex flex-col items-center">
                <div className="flex items-center">
                  <span
                    className={`text-3xl md:text-4xl lg:text-6xl font-albert-sans w-12 md:w-16 lg:w-24 text-center tabular-nums ${
                      isDark ? "text-white" : "text-black"
                    }`}
                  >
                  ...
                  <span
                    className={`text-3xl md:text-4xl lg:text-6xl font-albert-sans ${
                      isDark ? "text-white" : "text-black"
                    }`}
                  >
                    {" "}
              ...
              <div className="w-full md:w-auto mt-4 md:mt-0 md:pl-6 md:border-l md:border-gray-600 text-center md:text-left">
                <span
                  className={`text-xl md:text-2xl lg:text-3xl mr-2 ${
                    isDark ? "text-white" : "text-black"
                  }`}
                >
                  LEFT TO
                ...
                <span
                  className={`text-xl md:text-2xl lg:text-3xl font-albert-sans ${
